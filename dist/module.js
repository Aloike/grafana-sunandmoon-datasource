...
var ConfigEditor = function (_super) {
  ...
  function ConfigEditor(props) {
    ...
    _this.fillPositionFromGeoLocation = function () {
    ...
    _this.onLatitudeChange = function (event) {
    ...
    _this.onLongitudeChange = function (event) {
      var value = parseFloat(event.target.value);
      var _a = _this.props,
          onOptionsChange = _a.onOptionsChange,
          options = _a.options;
    ...
    _this.fillPositionFromGeoLocation();
  ...
  ConfigEditor.prototype.render = function () {
    ...
    }, "Sun and Moon reference location"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      className: "grafana-info-box"
    }, "This datasource calculates sun and moon metrics that are relative to a location on earth.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null), "The geographic position is expressed as latitude and longitude in decimal degrees."), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      className: "gf-form"
...
/*!***********************!*\
  !*** ./DataSource.ts ***!
  \***********************/
/*! exports provided: SunAndMoonDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SunAndMoonDataSource", function() { return SunAndMoonDataSource; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var suncalc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! suncalc */ "../node_modules/suncalc/suncalc.js");
/* harmony import */ var suncalc__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(suncalc__WEBPACK_IMPORTED_MODULE_3__);
...
var SunAndMoonDataSource = function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(SunAndMoonDataSource, _super);
  /* istanbul ignore next: workaround for https://github.com/gotwarlost/istanbul/issues/690 */


  function SunAndMoonDataSource(instanceSettings) {
    var _this = _super.call(this, instanceSettings) || this;

    _this.latitude = instanceSettings.jsonData.latitude;
    _this.longitude = instanceSettings.jsonData.longitude;
    return _this;
  }
  ...
  SunAndMoonDataSource.prototype.query = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      var range, from, to, maxDataPoints, stepInSeconds, errors, targets, data;
      ...
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        ...
        stepInSeconds = Math.ceil((to - from) / maxDataPoints);
        errors = [];
        targets = options.targets.filter(function (target) {
          return target.target && !target.hide;
        });
        data = targets.map(function (target) {
          var frame = new _grafana_data__WEBPACK_IMPORTED_MODULE_4__["MutableDataFrame"]({
            refId: target.refId,
            name: _types__WEBPACK_IMPORTED_MODULE_6__["sunAndMoonMetrics"][target.target].title,
            fields: [{
              name: 'Time',
          ...
          if (!!target.latitude) {
            latitude = parseFloat(Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__["getTemplateSrv"])().replace(target.latitude, options.scopedVars));
          ...
          if (!!target.longitude) {
            longitude = parseFloat(Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_5__["getTemplateSrv"])().replace(target.longitude, options.scopedVars));
          ...
          for (var time = from; time < to; time += stepInSeconds) {
            switch (target.target) {
              case 'moon_illumination':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonIllumination"](new Date(time)).fraction;
                break;

              case 'moon_altitude':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonPosition"](new Date(time), latitude, longitude).altitude * 180 / Math.PI;
                break;

              case 'moon_azimuth':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonPosition"](new Date(time), latitude, longitude).azimuth * 180 / Math.PI;
                break;

              case 'moon_distance':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonPosition"](new Date(time), latitude, longitude).distance;
                break;

              case 'sun_altitude':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getPosition"](new Date(time), latitude, longitude).altitude * 180 / Math.PI;
                break;

              case 'sun_azimuth':
                value = suncalc__WEBPACK_IMPORTED_MODULE_3__["getPosition"](new Date(time), latitude, longitude).azimuth * 180 / Math.PI;
                break;
            }
  ...
  SunAndMoonDataSource.prototype.annotationQuery = function (options) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, Promise, function () {
      var range, from, to, events, targets, date, lDateNextDay, sunTimes, moonTimes, sunTimesNextDay, values, setHours, noon, midnight, value, event, event, event;
      return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
        range = options.range;
        from = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["dateTime"])(range.from);
        to = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["dateTime"])(range.to).add(1, 'days');
        events = []; // Dashboards won't really be able to show huge amount of annotations.
        ...
        for (date = from; date < to; date.add(1, 'days')) {
          lDateNextDay = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_4__["dateTime"])(date);
          lDateNextDay.add(1, 'days');
          sunTimes = suncalc__WEBPACK_IMPORTED_MODULE_3__["getTimes"](date.toDate(), this.latitude, this.longitude);
          moonTimes = suncalc__WEBPACK_IMPORTED_MODULE_3__["getMoonTimes"](date.toDate(), this.latitude, this.longitude);
          sunTimesNextDay = suncalc__WEBPACK_IMPORTED_MODULE_3__["getTimes"](lDateNextDay.toDate(), this.latitude, this.longitude);
          values = lodash_merge__WEBPACK_IMPORTED_MODULE_2___default()({}, sunTimes, lodash_mapKeys__WEBPACK_IMPORTED_MODULE_1___default()(moonTimes, function (value, key) {
            return 'moon' + key;
          }));
          ...
          for (value in values) {
            ...
            event = {
              ...
              title: _types__WEBPACK_IMPORTED_MODULE_6__["sunAndMoonAnnotations"][value].title,
              text: _types__WEBPACK_IMPORTED_MODULE_6__["sunAndMoonAnnotations"][value].text,
              tags: _types__WEBPACK_IMPORTED_MODULE_6__["sunAndMoonAnnotations"][value].tags
            };
            events.push(event);
          } // Add "Night" region
...
var metrics = lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(_types__WEBPACK_IMPORTED_MODULE_5__["sunAndMoonMetrics"], function (metric, value) {
  return {
    label: metric.title,
    value: value,
...
var QueryEditor = function (_super) {
  ...
  function QueryEditor() {
    ...
    _this.onMetricChanged = function (selected) {
      var _a = _this.props,
  ...
  QueryEditor.prototype.render = function () {
    var query = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()(this.props.query, _types__WEBPACK_IMPORTED_MODULE_5__["sunAndMoonDefaultQuery"]);
    var datasource = this.props.datasource;
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      className: "gf-form-group"
    }, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
      className: "gf-form"
    }, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["InlineFormLabel"], null, "Metric"), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Select"], {
      className: "metric",
      options: metrics,
      value: query.target,
...
/* harmony import */ var _AnnotationQueryEditor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AnnotationQueryEditor */ "./AnnotationQueryEditor.tsx");
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["DataSourcePlugin"](_DataSource__WEBPACK_IMPORTED_MODULE_2__["SunAndMoonDataSource"]).setConfigEditor(_ConfigEditor__WEBPACK_IMPORTED_MODULE_3__["ConfigEditor"]).setQueryEditor(_QueryEditor__WEBPACK_IMPORTED_MODULE_4__["QueryEditor"]).setAnnotationQueryCtrl(_AnnotationQueryEditor__WEBPACK_IMPORTED_MODULE_1__["AnnotationQueryEditor"]);
...
/*!******************!*\
  !*** ./types.ts ***!
  \******************/
/*! exports provided: sunAndMoonMetrics, sunAndMoonAnnotations, sunAndMoonDefaultQuery */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sunAndMoonMetrics", function() { return sunAndMoonMetrics; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sunAndMoonAnnotations", function() { return sunAndMoonAnnotations; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sunAndMoonDefaultQuery", function() { return sunAndMoonDefaultQuery; });
var sunAndMoonMetrics = {
  moon_illumination: {
